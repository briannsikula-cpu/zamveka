...
import {
  Sun, Moon, Volume2, VolumeX, Bell, BellOff, Shield, LogOut, Trash2,
  User, Music, Download, Wifi, Eye, EyeOff, ChevronRight, Palette,
  Smartphone, Clock, SkipForward, ListMusic, Heart
} from "lucide-react";
    ...
    <div className="min-h-screen pb-32">
      <div className="pt-6 px-4 max-w-lg mx-auto">
        ...
        <GlassCard className="p-4" hover={false}>
          ...
          <SettingRow icon={<Volume2 className="w-5 h-5" />} label="Normalize volume" description="Keep volume level consistent">
